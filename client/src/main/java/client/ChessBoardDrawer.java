...
public class ChessBoardDrawer {
    ...
    public void drawWhitePerspective() {
        ...
        System.out.print(SET_BG_COLOR_TAN + BLACK_KNIGHT + SET_BG_COLOR_BROWN + BLACK_ROOK + SET_BG_COLOR_LIGHT_GREY + " 8 ");
        ...
        System.out.println(SET_TEXT_COLOR_BLACK + SET_BG_COLOR_LIGHT_GREY + " 2 " + RESET_BG_COLOR);
        ...
        System.out.println(SET_TEXT_COLOR_BLACK + SET_BG_COLOR_LIGHT_GREY + " 1 " + RESET_BG_COLOR);
    ...
    public void drawBlackPerspective() {
        System.out.print(SET_TEXT_COLOR_BLACK);
        System.out.print(SET_BG_COLOR_LIGHT_GREY + "    h   g   f  e   d  c   b   a    " + RESET_BG_COLOR + "\n");
        System.out.print(SET_BG_COLOR_LIGHT_GREY + " 1 " + SET_TEXT_COLOR_WHITE);
        System.out.print(SET_BG_COLOR_TAN + BLACK_ROOK + SET_BG_COLOR_BROWN + BLACK_KNIGHT);
        ...
        System.out.print(SET_BG_COLOR_TAN + BLACK_KNIGHT + SET_BG_COLOR_BROWN + BLACK_ROOK + SET_BG_COLOR_LIGHT_GREY);
        System.out.println(SET_TEXT_COLOR_BLACK + " 1 " + RESET_BG_COLOR);
        System.out.print(SET_BG_COLOR_LIGHT_GREY + " 2 ");
        for (int i = 0; i < 4; i++) {
            System.out.print(SET_BG_COLOR_BROWN + BLACK_PAWN + SET_BG_COLOR_TAN + BLACK_PAWN);
        }
        System.out.println(SET_BG_COLOR_LIGHT_GREY + " 2 " + RESET_BG_COLOR);
        System.out.print(SET_BG_COLOR_LIGHT_GREY + " 3 ");
        for (int i = 0; i < 4; i++) {
            System.out.print(SET_BG_COLOR_TAN + EMPTY + SET_BG_COLOR_BROWN + EMPTY);
        }
        ...
        System.out.print(SET_BG_COLOR_BROWN + BLACK_KNIGHT + SET_BG_COLOR_TAN + BLACK_ROOK);
        System.out.println(SET_BG_COLOR_LIGHT_GREY + " 8 " + RESET_BG_COLOR);
